<template>
  <v-container fluid>
    <v-card class="ma-3 pa-3">
      ...
      <v-card-text>
        <div class="my-4">
          <div class="subheading secondary--text text--lighten-3">Nickname</div>
          <div class="title primary--text text--darken-2" v-if="userProfile && userProfile.nickname">{{userProfile.nickname}}</div>
